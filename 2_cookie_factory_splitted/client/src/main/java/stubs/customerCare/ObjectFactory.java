...
public class ObjectFactory {
    ...
    private final static QName _ListAllRecipes_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "listAllRecipes");
    private final static QName _ListAllRecipesResponse_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "listAllRecipesResponse");
    private final static QName _Register_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "register");
    private final static QName _RegisterResponse_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "registerResponse");
    private final static QName _Track_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "track");
    private final static QName _TrackResponse_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "trackResponse");
    private final static QName _UnknownOrderId_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "UnknownOrderId");
    private final static QName _AlreadyExistingCustomerException_QNAME = new QName("http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", "AlreadyExistingCustomerException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "listAllRecipes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "listAllRecipesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "register")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "registerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "track")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "trackResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "UnknownOrderId")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.polytech.unice.fr/si/4a/isa/tcf/customer-care", name = "AlreadyExistingCustomerException")
